...
//! Array.prototype.map() | map takes an array, does something to it, returns NEW array with same length 
...
//!   FROM AN EXTERNAL WEBSITE EXAMPLE
// const category = document.querySelector('.mw-category');
// const links = [...category.querySelectorAll('a')] OR const links = Array.from(category.querySelectorAll('a'));
// const de = links
...
// })
//* TERNARY VERSION
const alphabetical = people.sort((a, b) => a.charAt(1) > b.charAt(1) ? 1 : -1)
